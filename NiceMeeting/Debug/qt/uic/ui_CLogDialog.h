...
public:
    ...
    void setupUi(QDialog *CLogDialogClass)
    {
        ...
        CLogDialogClass->resize(724, 618);
        ...
        widget_left->setMinimumSize(QSize(400, 400));
        ...
        LeftList_Vlayout->setContentsMargins(9, 9, 9, 9);
        verticalSpacer_2 = new QSpacerItem(20, 50, QSizePolicy::Minimum, QSizePolicy::Fixed);

        LeftList_Vlayout->addItem(verticalSpacer_2);
        ...
        horizontalLayout_3->addWidget(BtnSetting);
        ...
        LeftList_Vlayout->addItem(verticalSpacer_3);
        ...
        BigVideoWidget_Vlayout->setSpacing(6);
        ...
        BigVideoWidget_Vlayout->setContentsMargins(9, 9, 9, 9);
    ...
    void retranslateUi(QDialog *CLogDialogClass)
    {
        ...
        BtnNetStatus->setText(QCoreApplication::translate("CLogDialogClass", "PushButton", nullptr));
